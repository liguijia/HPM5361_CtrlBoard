...
/* Trigger UART: UART0~3 use HPM_TRGM0_OUTPUT_SRC_UART_TRIG0, UART4~7 use
...
#define BOARD_UART_LIN_TX_PIN                                                  \
  (15U) /* PA15 should align with used pin in pinmux configuration */
...
#define BOARD_BLDC_ADC_PMT_DMA_SIZE_IN_4BYTES                                  \
